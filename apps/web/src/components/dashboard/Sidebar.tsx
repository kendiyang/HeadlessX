        ...
        >
            ...
            <div className={cn(collapsed ? "px-3 py-4" : "px-4 py-4")}>
                ...
                <button
                    ...
                    className={cn(
                        "mt-3 flex items-center justify-center gap-2 rounded-[1rem] border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50 hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-60",
                        collapsed ? "h-11 w-full px-0" : "h-11 w-full"
                    )}
