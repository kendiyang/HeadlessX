...
// Amazon operator: /api/operators/amazon/*
import amazonRoutes from './routes/commerce/amazonRoutes';
app.use('/api/operators/amazon', amazonRoutes);

// eBay operator: /api/operators/ebay/*
import ebayRoutes from './routes/commerce/ebayRoutes';
app.use('/api/operators/ebay', ebayRoutes);

// Walmart operator: /api/operators/walmart/*
import walmartRoutes from './routes/commerce/walmartRoutes';
app.use('/api/operators/walmart', walmartRoutes);

// Reddit operator: /api/operators/reddit/*
import redditRoutes from './routes/social/redditRoutes';
app.use('/api/operators/reddit', redditRoutes);
...
app.get('/api/health', (req, res) => {
    res.json({
        ...
        endpoints: {
            ...
            amazon: '/api/operators/amazon/*',
            ebay: '/api/operators/ebay/*',
            walmart: '/api/operators/walmart/*',
            reddit: '/api/operators/reddit/*',
            proxies: '/api/proxies/*',
            config: '/api/config',
            keys: '/api/keys',
            logs: '/api/logs',
