...
Amazon inspect returns a flattened payload:
...
```bash
headlessx walmart inspect https://www.walmart.com/ip/...
headlessx walmart inspect 123456789 --marketplace walmart.com
headlessx walmart status
```

## Reddit

```bash
headlessx reddit inspect https://www.reddit.com/r/AskMarketing/comments/1s0kubi/sick_of_the_backandforth_for_tiktok_spark_ads
headlessx reddit inspect /r/AskMarketing/comments/1s0kubi/sick_of_the_backandforth_for_tiktok_spark_ads --sort new --limit 200 --depth 5
headlessx reddit inspect 1s0kubi --include-raw
headlessx reddit status
```
...
- `/api/operators/amazon/*`
- `/api/operators/ebay/*`
- `/api/operators/walmart/*`
- `/api/operators/reddit/*`
- `/api/jobs/*`
